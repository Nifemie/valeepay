...
class ShoppingSavedBeneficiaryScreen extends StatelessWidget {
  const ShoppingSavedBeneficiaryScreen({super.key});
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Add beneficiaries to make shopping payments faster',
            style: TextStyle(
