...
import '/features/dashboard/widgets/services_widgets/giftcard_widgets/quantity_selector_modal.dart';
import '/features/dashboard/view/services/giftcard/service_provider_screen.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  '₦${(50000 * quantity).toStringAsFixed(0)}',
                  style: TextStyle(
                    color: isDark ? Colors.white : Colors.black,
                    fontSize: 16,
                    fontWeight: FontWeight.w600,
