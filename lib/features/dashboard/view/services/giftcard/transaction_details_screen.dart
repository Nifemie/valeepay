...
import '/features/dashboard/widgets/services_widgets/giftcard_widgets/payment_method_modal.dart';
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildDetailRow('Rate', '₦1000/£', isDark),
                  _buildDetailRow('Payable Amount (₦)', '₦100,000', isDark),
                ],
              ),
            ),
