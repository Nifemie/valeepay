...
class CableTvSavedBeneficiaryScreen extends StatelessWidget {
  const CableTvSavedBeneficiaryScreen({super.key});
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Add beneficiaries to make cable TV payments faster',
            style: TextStyle(
