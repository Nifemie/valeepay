...
class PaymentMethodModal extends StatelessWidget {
  ...
  void _showPinEntry(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const PinEntryModal(),
    );
  }
}

class PinEntryModal extends StatefulWidget {
  const PinEntryModal({super.key});

  @override
  State<PinEntryModal> createState() => _PinEntryModalState();
}

class _PinEntryModalState extends State<PinEntryModal> {
  String pin = '';
