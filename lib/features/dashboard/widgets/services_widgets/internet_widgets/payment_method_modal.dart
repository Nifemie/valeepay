...
class InternetPaymentMethodModal extends StatelessWidget {
  ...
  const InternetPaymentMethodModal({
    super.key,
  ...
  void _showPinEntry(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => InternetPinEntryModal(
...
class InternetPinEntryModal extends StatefulWidget {
  final Map<String, String> transactionData;

  const InternetPinEntryModal({
    super.key,
    required this.transactionData,
  });

  @override
  State<InternetPinEntryModal> createState() => _InternetPinEntryModalState();
}

class _InternetPinEntryModalState extends State<InternetPinEntryModal> {
  String pin = '';
              ...
              Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                  builder: (context) => InternetTransactionSuccessScreen(
                    ...
                    transactionDetails: {
                      'Service Provider':
                          widget.transactionData['provider'] ?? 'Spectranet',
                      'Phone Number':
                          widget.transactionData['phoneNumber'] ?? '0000000000',
                      'Plan':
                          widget.transactionData['plan'] ?? '100MB Daily Plan',
                      'Amount': '₦${widget.transactionData['amount'] ?? '500'}',
