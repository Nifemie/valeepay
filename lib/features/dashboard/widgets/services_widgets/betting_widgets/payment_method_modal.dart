...
class BettingPaymentMethodModal extends StatelessWidget {
  ...
  void _showPinEntry(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => BettingPinEntryModal(
...
class BettingPinEntryModal extends StatefulWidget {
  final Map<String, String> transactionData;

  const BettingPinEntryModal({
    super.key,
    required this.transactionData,
  });

  @override
  State<BettingPinEntryModal> createState() => _BettingPinEntryModalState();
}

class _BettingPinEntryModalState extends State<BettingPinEntryModal> {
  String pin = '';
              ...
              Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                  builder: (context) => BettingTransactionSuccessScreen(
                    ...
                    transactionDetails: {
                      'Service Provider':
                          widget.transactionData['provider'] ?? 'Bet9ja',
                      'User ID':
                          widget.transactionData['userId'] ?? '0000000000',
                      'Amount':
                          '₦${widget.transactionData['amount'] ?? '10,000'}',
