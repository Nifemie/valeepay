...
class InsurancePaymentMethodModal extends StatelessWidget {
  ...
  const InsurancePaymentMethodModal({
    super.key,
  ...
  void _showPinEntry(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => InsurancePinEntryModal(
...
class InsurancePinEntryModal extends StatefulWidget {
  final Map<String, String> transactionData;

  const InsurancePinEntryModal({
    super.key,
    required this.transactionData,
  });

  @override
  State<InsurancePinEntryModal> createState() => _InsurancePinEntryModalState();
}

class _InsurancePinEntryModalState extends State<InsurancePinEntryModal> {
  String pin = '';
