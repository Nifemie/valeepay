...
class GenerateQrNotifier extends StateNotifier<DataState<GenerateQrResponse>> {
  ...
  GenerateQrNotifier(this._repository) : super(DataState<GenerateQrResponse>.initial());
...
final generateQrNotifierProvider = StateNotifierProvider<GenerateQrNotifier, DataState<GenerateQrResponse>>((ref) {
